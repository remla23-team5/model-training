    ...
    def test_pipeline(self) -> None:
        ...
        with runner.isolated_filesystem():
            download_result = runner.invoke(
                download_data, ["1bCFMWa1lgymQtj6vukXTrtfF47TeKQLu", "test_file.tsv"]
            )
            ...
            preprocess_result = runner.invoke(
                make_dataset, ["test_file.tsv", "test_file_preprocessed.tsv"]
            )
            ...
            train_result = runner.invoke(
                train_model,
                ["test_file_preprocessed.tsv", "test_model.pkl", "test_metrics.json"],
            )
